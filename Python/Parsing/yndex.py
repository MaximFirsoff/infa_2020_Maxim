...
#    ourprice = soup.select('span', {'class': 'c8q7 c8q8'})  # Получаем строку с ценой
    ourprice = soup.find_all('span', {'class': re.compile("(c8q7|c8q8)")})  # Получаем строку с ценой for both "c8q7" and "c8q7 c8q8" classes
    ourprice = str(ourprice).replace(u'\xa0', '')  # getout non-breaking spaces
